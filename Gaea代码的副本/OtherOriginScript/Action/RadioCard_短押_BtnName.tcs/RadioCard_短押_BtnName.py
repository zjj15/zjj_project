...
if 'play' == key_name_lower:
    ...
    touch(Template('../../Design/MusicCard_next.png'),  predict_area=[y,y+h,x,x+w], threshold=0.95)
elif 'previous' == key_name_lower:
    touch(Template('../../Design/MusicCard_previous.png'),  predict_area=[y,y+h,x,x+w], threshold=0.95)
else:
    error('invalid param')
