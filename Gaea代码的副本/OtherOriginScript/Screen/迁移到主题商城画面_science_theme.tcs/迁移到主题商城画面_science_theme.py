...
flick_to(Template('../../Design/science_theme_theme_shop_icon.png'), [957, 347], DIR_LEFT, step=1, speed=SPEED_NORMAL)

touch(Template('../../Design/science_theme_theme_shop_icon.png'),device=DEV1)
for _ in range(4):
