...
try:
    if exists(Template('../../Design/FaultDiag_ConfigFile_ModelSelect.png'),device=DEV1, timeout=4):
        ...
        flick_to(Template('../../Design/FaultDiag_ConfigFile_Update_High.png'), [799, 481], DIR_UP, step=1, speed=SPEED_NORMAL)


        touch(Template('../../Design/FaultDiag_ConfigFile_Update_High.png'),device=DEV1)
