...
def check():
    if exists(Template('../../Design/OnlineVideo_vip_icon.png'), timeout=1,threshold = 0.88) or exists(Template('../../Design/OnlineVideo_vip_icon_big.png'), timeout=1,threshold = 0.88):
        pass
