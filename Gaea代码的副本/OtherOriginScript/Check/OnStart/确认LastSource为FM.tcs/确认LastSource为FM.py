...
try:
    assert_exists(Template('../../../Design/statusbar_FM.png'), threshold=0.90, device=DEV1)
    rect_target_area=[992, 112, 390, 540]#rect_target_area=poco('android.widget.ImageView', nearest=({'text':'电台'})).get_attr('rect')
