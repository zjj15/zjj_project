...
do_segment(Segment("../../Action/iQIYI_选中选集list.tcs"))
...
ST.OnlineVideo_Num_last = poco(className='android.widget.TextView', pos2=[307, 136]).get_attr('text')
print('数字剧集List最后一集：'+ST.OnlineVideo_Num_last)