...
def check():
    if exists(Template("../../Design/OnlineVideo_vip_icon.png"), timeout=1,threshold = 0.9) or exists(Template("../../Design/OnlineVideo_vip_icon_big.png"), timeout=1,threshold = 0.9):
        error('iQIYI_确认无VIP角标 error')
