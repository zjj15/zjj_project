...
if exists(Template('../../Design/OnlineVideo_Play_Bar.png'), threshold=0.95):
    ...
    print('iQIYI_确认视频1倍速播放_Start:', progress_startTo)
    print('iQIYI_确认视频1倍速播放_End:', progress_startTo1)
    ...
    if time_diff<=8:
       pass
        ...
        error('iQIYI_确认视频1倍速播放 error!!')
do_segment(Segment('../iQIYI_确认Rate为1.tcs'))
