...
dict_set_balance_step ={
    0: ST.P42Q_H_BALANCE_0,
    1: ST.P42Q_H_BALANCE_1,
    -1: ST.P42Q_H_BALANCE_m1,
    2: ST.P42Q_H_BALANCE_2,
    -2: ST.P42Q_H_BALANCE_m2,
    3: ST.P42Q_H_BALANCE_3,
    -3: ST.P42Q_H_BALANCE_m3,
    4: ST.P42Q_H_BALANCE_4,
    -4: ST.P42Q_H_BALANCE_m4,
    5: ST.P42Q_H_BALANCE_5,
    -5: ST.P42Q_H_BALANCE_m5
}
...
touch([dict_set_balance_step[balance_step],ST.P42Q_H_FADER_0],device=DEV1)
touch([dict_set_balance_step[balance_step],ST.P42Q_H_FADER_0],device=DEV1)
...
try:
    ...
    error('[P42Q_High SoundEffect/BALANCE/step%s setting error' % balance_step)
