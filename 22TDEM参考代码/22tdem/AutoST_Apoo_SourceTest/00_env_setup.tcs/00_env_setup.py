...
ST.DEV1 = 'Apoo://127.0.0.1:5037/GFEDCBA0987654321'
ST.DEV2 = 'iSpeed:///?stream_method=camera'
#系统的启动时间，上限值
ST.system_startUp_Time = 60

##截屏匹配区域定义
#tuner
ST.eare_tuner=[1388, 106, 460, 584]
#usb audio,bt,ipod
ST.eare_devices1=[774, 106, 465, 392]#full of softbar
ST.eare_devices2=[774, 255, 465, 190]#part without string
