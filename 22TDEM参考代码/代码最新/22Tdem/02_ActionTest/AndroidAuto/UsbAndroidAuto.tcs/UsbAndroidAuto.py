...
usb_on(2)
if exists(Template("pic/AA_连接成功.png"), threshold=ST.allSource_threshold, timeout=10, device=DEV1):
    print('AA_连接成功')
elif exists(Template("pic/AndroidAuto卡片.png"), threshold=ST.allSource_threshold):
    touch([299, 337])
    sleep(5)
...
#复归
usb_off(2)
do_segment(Segment('../../../01_Source_AccOffOn/AndroidAuto/AA_残留内容删除.tcs'))
