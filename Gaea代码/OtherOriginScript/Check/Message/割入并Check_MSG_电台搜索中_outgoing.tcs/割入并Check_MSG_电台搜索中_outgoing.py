...
touch_if(Template('../../Design/Phone_A_MB_0107/Diag_CallBegin.png'), device=DEV7, threshold=0.95)

touch_if(Template('../../Design/Phone_S_MB_0569/BTCalling_hangup_3.png'), timeout=30, device=DEV2)
