...
try:
    assert_exists(Template('../../../Design/statusbar_kugou.png'), threshold=0.90, device=DEV1)
    ...
    #wifi not ok
    #assert_exists(Template('../../../Design/MusicCard_playing.png'),  predict_area=[y,y+h,x,x+w], timeout=35)
except:
