...
def check():
    if exists(Template('../../Design/OnlineVideo_自制_icon.png'), timeout=1,threshold = 0.88) or exists(Template('../../Design/OnlineVideo_自制_大icon.png'), timeout=1,threshold = 0.88):
        pass
